...
{
    public partial class EditPhilosopher : Form
    {
        ...
        private void EditPhilosopher_Load(object sender, EventArgs e)
        {
            txtName.Text = Edit.name;
            txtNation.Text = Edit.nationality;
            if (Edit.born < 0)
            {
                chkBornBCE.Checked = true;
                txtBorn.Text = (-1 * Edit.born).ToString();
            }
            else
                txtBorn.Text = Edit.born.ToString();
            if (Edit.died < 0)
            {
                chkDiedBCE.Checked = true;
                txtDied.Text = (-1 * Edit.died).ToString();
            }
            else
                txtDied.Text = Edit.died.ToString();
            txtWorks.Text = Edit.famousWorks;
            txtBiography.Text = Edit.biography;
        ...
        private void EditPhilosopher_FormClosing(object sender, FormClosingEventArgs e)
        {
